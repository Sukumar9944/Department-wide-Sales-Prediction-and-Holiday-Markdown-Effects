...
@st.cache_resource
def load_model():
    model = pickle.load(open('ML_Flow_runs\Model_0.3\Artifacts\Predictor_model\model.pkl', 'rb'))
    return model

model = load_model()

transformer = pickle.load(open('ML_Flow_runs\Model_0.3\Artifacts\Transformer\model.pkl','rb'))
